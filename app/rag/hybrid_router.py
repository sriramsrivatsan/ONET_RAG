...
class HybridQueryRouter:
    ...
    def __init__(self):
        ...
        logger.info(f"✓ v4.0.4: HybridQueryRouter initialized with generic pattern engine", show_ui=False)
    ...
    def _extract_parameters(self, query_lower: str) -> Dict[str, Any]:
        ...
        if detected_category:
            ...
            logger.info(f"✓ v4.0.4: Detected entity: {detected_category}", show_ui=False)
